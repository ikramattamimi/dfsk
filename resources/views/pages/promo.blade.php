...
@section('content')
    <!-- Blog Start -->
    <div class="container-fluid p-0  mt-lg-5 pt-lg-4 fadeInUp" data-wow-delay="0.1s">
        <div class="container">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="nv-content-wrap entry-content">
                            ...
                            <p>Sebelum promo berakhir, segera kunjungi&nbsp;<strong><em>Dealer Mobil DFSK Bandung</em></strong>&nbsp;hubungi&nbsp;<strong>Bejat Sales Executive DFSK</strong>&nbsp;di no&nbsp;<a href="tel:+6281214098888"><strong>081214098888</strong>&nbsp;</a>yang siap membantu Anda.</p>
                            <ul class="wp-block-list">
